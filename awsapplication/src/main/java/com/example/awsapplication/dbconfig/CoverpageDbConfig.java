...
@EnableJpaRepositories(
        basePackages = "com.example.awsapplication.repo.coverpage",
        entityManagerFactoryRef = "coverpageEmf",
        transactionManagerRef = "coverpageTx"
)
@RequiredArgsConstructor
public class CoverpageDbConfig {
    ...
    @Bean
    public LocalContainerEntityManagerFactoryBean coverpageEmf() {
        LocalContainerEntityManagerFactoryBean emf = new LocalContainerEntityManagerFactoryBean();
        emf.setDataSource(coverpageDataSource());
    ...
    @Bean
    public PlatformTransactionManager coverpageTx() {
        return new JpaTransactionManager(coverpageEmf().getObject());
    }
}
